public class TesteLanchonete {
    public static void main(String[] args){
        ...
        System.out.println("Refrigerante: "+a3.id+" "+a3.marca+" "+"valor: "+a3.preco);
        System.out.println("Pizza: "+a2.id+" "+a2.nomepizza+" "+"valor: "+a2.preco);        
        System.out.println("Lanche: "+a1.id+" "+a1.nomelanche+" "+"valor: "+a1.preco);        
    } 
}
